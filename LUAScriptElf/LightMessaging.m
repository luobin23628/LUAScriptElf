...
{
	return LMConnectionSendTwoWayData(connection, messageId, archiverObject ? (__bridge CFDataRef)[NSKeyedArchiver archivedDataWithRootObject:archiverObject] : NULL, buffer);
}
